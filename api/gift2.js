import {obter_numero_positivo, obter_texto, mostrar_texto} from './my_io_utils.js'

function main(){
    const nome = obter_texto('Digite o nome do cliente:')
    const qtd_de_compras = obter_numero_positivo('Digite a quantidade de compras realizada pelo cliente:')
